...
*Это мой первый опыт перевода статей, об ошибках просьба сообщать на  почту (<re9ulusV@gmail.com>).*
...
![Machine learning algorithm is a black box](/img/ml_is_fun/im1_rus.png)
...
![Math quiz 1](/img/ml_is_fun/im1_rus.png)
...
![Plot of cost function](/img/ml_is_fun/im3.png)
...
![Plot of cost function with dots](/img/ml_is_fun/im4_rus.png)
...
![Relationship model](/img/ml_is_fun/im5_rus.png)
